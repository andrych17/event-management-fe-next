...
export default function ConfigsPage() {
  ...
  }, [groupCode, search, perPage, currentPage, sortBy, sortDir, isAuthenticated]);
  ...
  useEffect(() => {
    if (showForm && formData.group_code === 'Floor') {
      loadLocations();
    }
  }, [showForm, formData.group_code]);
  ...
  const loadConfigs = async () => {
    ...
    try {
      ...
      const response = await api.getConfigs(currentPage, perPage, search, group, undefined, sortBy, sortDir);
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl border-2 border-gray-200 p-6 space-y-4 animate-fadeIn mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => { setGroupCode('All'); setCurrentPage(1); }}
                        ...
                        <button
                          onClick={() => { setGroupCode('Location'); setCurrentPage(1); }}
                          className={`px-6 py-2 rounded-lg font-semibold transition-all ${
                            groupCode === 'Location'
                              ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg'
                              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                        ...
                        <button
                          onClick={() => { setGroupCode('Floor'); setCurrentPage(1); }}
                          className={`px-6 py-2 rounded-lg font-semibold transition-all ${
                            groupCode === 'Floor'
                              ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg'
                              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      ...
                      <tr>
                        <td colSpan={6} className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center gap-4">
                            ...
                            <span className="text-gray-600 font-medium">Loading configurations...</span>
                          </div>
                        </td>
                      </tr>
                    ) : configs.length === 0 ? (
